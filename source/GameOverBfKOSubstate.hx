...
class GameOverBfKOSubstate extends MusicBeatSubstate
{
	var bf:Boyfriend;
	...
	public function new(x:Float, y:Float)
	{
		...
		FlxG.sound.play(Paths.sound('bfKo'));
	...
	override function update(elapsed:Float)
	{
		...
		if (bf.animation.curAnim.name == 'KO' && bf.animation.curAnim.curFrame == 12)
		{
		...
		if (bf.animation.curAnim.name == 'KO' && bf.animation.curAnim.finished)
		{
